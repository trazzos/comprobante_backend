<?php
namespace Modules\Invoice\Services\Filters;
...
/**
 * Class InvoiceName
 * @package Modules\Invoice\Services\Filters
 */
class InvoiceName extends FilterAbstract implements CriteriaInterface {
    /**
     * @var array
     */
    protected $predicate;
